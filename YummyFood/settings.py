...
ALLOWED_HOSTS = ['sohanyf.pythonanywhere.com', 'localhost']
...
ACCOUNT_EMAIL_CONFIRMATION_ANONYMOUS_REDIRECT_URL = 'http://frontend-domain.com/login'
ACCOUNT_EMAIL_CONFIRMATION_AUTHENTICATED_REDIRECT_URL = 'http://frontend-domain.com/login'
